...
export abstract class BaseRepository {
  /**
   * Ejecuta una función almacenada que devuelve filas (`SELECT * FROM nombre_función($1,...)`).
   * Si la primera celda parece un cursor de PostgreSQL, hace `FETCH ALL` y devuelve esas filas.
   * Usa una transacción (BEGIN / COMMIT o ROLLBACK si falla).
   */
