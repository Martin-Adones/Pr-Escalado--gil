...
const INFO_DESCRIPTION =
  'Auditoria: endpoints del dominio auditoria bajo `/api/auditoria` (pendiente de implementacion).';
...
export const registerSwagger = async (app: FastifyInstance) => {
  await app.register(swagger, {
    openapi: {
      openapi: '3.0.3',
      info: {
        title: 'PDAE · Microservicio Auditoria',
      ...
      tags: [
        { name: 'Auditoria', description: 'Operaciones de auditoria (pendiente).' },
